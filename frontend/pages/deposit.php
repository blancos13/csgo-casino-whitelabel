<?php
	$steam_options = array(
		//array("Diamond Lock", "Instant 0.1 Second", "csgo", "steam/csgo", "transparent"),
	...
	$crypto_options = array(
		...
		//array("Diamond Locks", "Diamond Locks", "dl", "currency/dl", "#9E55DF"),
	);
?>
	...
	<div class="wrapper-page flex row">
		<div class="flex column height-full width-full">
			...
			<div class="width-12 options-container">
				<h3 class="dp-title" style="margin-top:0">Growtopia Deposit</h3>
