...
<div class="mt-2 jackpot">
	...
	<div class="flex responsive justify-center">
		<div class="jpppp">
			...
			<div class="input_field jackpot-input bet_input_field transition-5" data-border="#de4c41">
				<div class="field_container">
					<div class="field_content jp">
						...
						<div class="field_label transition-5"><i class="mr-1 coins" style="margin:0 4px 0 0;font-size:12px"></i>Bet Amount</div>
					</div>
					
					<div class="field_extra jp">
					<button class="site-button betshort_action" data-game="jackpot" data-action="clear">Clear</button>
					...
					<button class="site-button betshort_action" data-game="jackpot" data-action="half">1/2</button>
					<button class="site-button betshort_action" data-game="jackpot" data-action="double">x2</button>
					<button class="site-button betshort_action" data-game="jackpot" data-action="max">Max</button>
			...
			<div class="round-containers current-round">
				<div class="progress-container meter small width-full rounded-0 mb-2 jp-progress">
				<div class="transition-10 linear rounded-0" id="jackpot_counter" style="width: 100%"></div>
					<div class="progress-contents flex justify-center items_center" id="jackpot_timer">
						Waiting for players...
					</div>
				</div>
