...
<div class="home">
  ...
  <h2>Live winnings</h2>
  <div style="width:100%;height:3px;float:left;background:linear-gradient( 360deg, #ab33c1 0%, #58277d 100.26%, rgba(11, 104, 192, 0) 100%, #33c16c 100%);margin:3px 0 10px"></div>

  <div class="table-container responsive" style="width:100%;">
