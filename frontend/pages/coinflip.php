		...
		<div class="flex responsive items-center justify-between gap-2 cf-coins">
			<div class="cf-coins-bg">
				...
				<div class="rounded-full coinflip-select active" data-coin="1">
					<img src="<?php echo $site['root'];?>template/img/coinflip/image.png">
				</div>
				<div class="rounded-full coinflip-select" data-coin="2">
					<img src="<?php echo $site['root'];?>template/img/coinflip/image2.png">
				</div>
			</div>
			
			<button class="site-button purple" id="coinflip_create">
    <i class="fa fa-plus-circle" style="margin-right: 5px;"></i>Create Game
</button>
		</div>
	</div>
</div>
