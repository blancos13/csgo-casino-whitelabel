<?php
	 $steam_options = array(
//	array("Diamond Lock", "Manual/Auto", "csgo", "steam/csgo", "#2B3254"),
...
<div class="flex column height-full width-full">
	<div class="wrapper-page flex row">
		<div class="flex column height-full width-full">
			...
			<h3 class="dp-title">Growtopia Withdraw</h3>

				<div class="options-container-grid">
					<?php foreach ($steam_options as $value) { ?>
						<a href="<?php echo $site['root'];?>withdraw/<?php echo $value[3]; ?>">
							<div class="option">
				...
				<!-- <h3 class="dp-title">P2P Withdraw</h3> -->
